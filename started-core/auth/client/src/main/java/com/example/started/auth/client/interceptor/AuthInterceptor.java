package com.example.started.auth.client.interceptor;

import com.example.started.auth.client.LoginStatusVerification;
import com.example.started.auth.client.TokenDto;
import com.example.started.auth.client.annotation.RequireAuth;
import com.example.started.auth.client.config.AppConfig;
...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        // 检查认证
        TokenDto tokenCookie = LoginStatusVerification.getTokenCookie(request);
        // todo 检查token 是否过期
