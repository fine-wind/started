...
import com.example.started.modules.auth.config.CustomPasswordEncoder;
import com.example.started.modules.auth.config.JwtConfig;
import com.example.started.modules.auth.user.AuthUserEntity;
import com.example.started.modules.auth.user.AuthUserService;
