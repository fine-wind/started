package com.example.started.api.modules.oss.controller;

import com.example.started.api.modules.oss.service.SysOssService;
import com.example.common.v0.exception.ServerException;
import com.example.common.v0.utils.StringUtil;
import com.example.started.api.modules.oss.bo.SysOssBo;
import com.example.started.api.modules.oss.cloud.AbstractCloudStorageService;
import com.example.started.api.modules.oss.cloud.CloudStorageConfig;
import com.example.started.api.modules.oss.cloud.OSSFactory;
import com.example.started.api.modules.oss.entity.SysOssEntity;
...
public class SysOssController {
    ...
    public Result<Map<String, Object>> upload(@RequestParam("file") MultipartFile file) throws Exception {
        ...
        //上传文件
        String extension = null;// todo FilenameUtils.getExtension(file.getOriginalFilename());
