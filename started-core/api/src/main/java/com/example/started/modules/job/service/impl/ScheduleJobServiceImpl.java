package com.example.started.modules.job.service.impl;

import com.alibaba.fastjson.JSON;
import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;

import com.example.started.modules.job.bo.ScheduleJobBo;
import com.example.started.modules.job.dao.ScheduleJobDao;
import com.example.started.modules.job.dto.ScheduleJobDTO;
...
import com.example.started.modules.job.service.ScheduleJobService;
...
public class ScheduleJobServiceImpl extends BaseServiceImpl<ScheduleJobBo, ScheduleJobDao, ScheduleJobEntity> implements ScheduleJobService {
    ...
    public QueryWrapper<ScheduleJobEntity> getWrapper(ScheduleJobEntity params) {
        ...
        wrapper.like(!StringUtil.isEmpty(beanName), "bean_name", beanName);
