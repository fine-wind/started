...
public class JwtUtils {
    ...
    public String parseJWT(String token) {
        ...
        try {
            ...
            Claims decoder = claimsJws.getPayload();
            if (Objects.nonNull(decoder) && Objects.nonNull(decoder.getExpiration()) && decoder.getExpiration().after(DateUtil.now())) {
                return String.valueOf(decoder.get(Constant.User.Login.USERNAME));
            }
        } catch (Exception e) {
        }
        return null;
