...
public class StringUtil {
    ...
    public static boolean isEmpty(String... chkStr) {
        ...
        for (String str : chkStr) {
            if (str == null || NULL_STRING.equals(str.trim())) {
                return true;
            }
        }
        return false;
     ...
     * @return 隔开后的字符串
     */
    public static <T> String join(T[] objects, String join) {
    ...
    public static String humpTo_(String hump) {
    ...
    public static String defaultValue(String... showName) {
