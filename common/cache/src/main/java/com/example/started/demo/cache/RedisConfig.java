...
public class RedisConfig {
    ...
    @Autowired
    public RedisConfig(ApplicationContext applicationContext, RedisConnectionFactory factory) {
    ...
    private Map<String, RedisCacheConfiguration> getRedisCacheConfigurationMap() {
        ...
        //自定义设置缓存时间
        applicationContext.getBeansOfType(CacheKeyTimeConfig.class)
                .values()
                .forEach(cacheKeyTimeConfig -> cacheKeyTimeConfig.cacheKeys().forEach(cacheKey -> map.put(cacheKey.getKey(), this.getTtl(Duration.ofMinutes(cacheKey.getTime()).getSeconds()))));
        return map;
    }
