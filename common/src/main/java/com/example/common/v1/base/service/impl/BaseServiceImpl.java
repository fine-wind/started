 ...
 * @param <T>   实体类
 */
public class BaseServiceImpl<DTO extends BaseDto, DAO extends BaseDao<T>, T extends BaseEntity> implements BaseService<DTO, T> {
    @Autowired
    protected DAO baseDao;

    @SuppressWarnings("resource")
    protected Class<T> currentEntityClass() {
        return (Class<T>) ReflectionKit.getSuperClassGenericType(BaseServiceImpl.class, getClass(), 2);
    }

    protected Class<DTO> currentDtoClass() {
        return (Class<DTO>) ReflectionKit.getSuperClassGenericType(this.getClass(), getClass(), 2);
    }
    // region c
    ...
    public boolean insert(DTO dto) {
        ...
        return BaseServiceImpl.retBool(insert);
    }
