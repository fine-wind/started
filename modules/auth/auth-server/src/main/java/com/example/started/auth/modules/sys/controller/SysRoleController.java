package com.example.started.auth.modules.sys.controller;
...
public class SysRoleController {
    ...
    public Result<PageData<SysRoleDTO>> page(@RequestBody SysRoleBo params) {
    ...
    public Result<SysRoleDTO> get(@PathVariable("id") Long id) {
        ...
        //查询角色对应的菜单
        List<Long> menuIdList = null;// todo sysRoleMenuService.getMenuIdList(id);
