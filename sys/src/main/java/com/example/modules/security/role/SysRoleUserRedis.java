...
public class SysRoleUserRedis {
    ...
    public void setRoles(String username, Set<String> roles) {
        redisUtils.opsForSet().add(CacheCommonKeys.getSecurityRoleKey(username), roles);
    }

    public Set<Object> getRoles(String username) {
        Set<Object> members = redisUtils.opsForSet().members(CacheCommonKeys.getSecurityRoleKey(username));
        return members;
    }
